...
|-------|---------|---------|
| `/arch-defense` | Brief in hand | Brief (+ codebase) → `ArchDefense.md` *and* `ArchDefense.pptx` — **standalone, the arch defense; run before anything below.** Uses an existing `ArchDefense.md` as-is, never overwrites it |
